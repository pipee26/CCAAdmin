...
$json['img']=array();
	...
	if(isset($_POST["btn"])){
		...
		$sql="INSERT INTO empresas(tipo,nombre,direccion,telefono,horario,pgfb,urlimagen) VALUES (?,?,?,?,?,?,?)";
		$stm=$conexion->prepare($sql);
		
		$stm->bind_param('sssssss',$tipo,$nombre,$direccion,$telefono,$horario,$pgfb,$ruta);
		$stm->execute();
...
<main>
        ...
        <div class="container">
                <form method='POST' action="subir-empresa.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group " id="divselectipo"> 
                            ...
                            <select class="form-control col-md-3" id="selecttipo" name="tipo">
                    ...
                    <div class="row">
                        <div class="col-md-3" id="divlabelcurso">
                    ...
                    <div id="ae">
                        ...
                        <a href="tablaempresas.php" class="btn btn-warning" id="">Ver Empresas</a>
                    </div>
                </form>
        </div>
    </main>
