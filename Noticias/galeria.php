...
<body>
<BR>
    <h3 id="h3tabla">GALERIA DE IMAGENES</h3>
    <BR>
    <div id="divimagen">
    ...
    <table class="table table-success" id="tablaempresas">
        <thead>
            <tr>
                ...
                <th scope="col">
                    <center>NOTICIA A LA QUE PERTENECE</center>
                </th>
        ...
        <tbody>
            <?PHP
                ...
                $consul="SELECT * FROM  carruselnoticias";
            ...
            <tr>
                ...
                <td>
                    <center>
                        <?PHP echo $row['noticias']?>
                    </center>
                </td>
                
                
                <td>
                    <a href="editargaleria.php?id_cn=<?php echo $row['id_cn'] ?>" class="button">
                        <center><button type="button" class="btn btn-primary" name="btn"> Editar </button></center>
                    </a>
                </td>
                <td>
                    <a href="eliminargaleria.php?id_cn=<?php echo $row['id_cn'] ?>" class="button">
