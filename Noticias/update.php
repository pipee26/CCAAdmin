...
<?php
	...
	$sql = "UPDATE noticias SET  encabezado='$encabezado',urlimagen='$ruta', descripcion='$descripcion' WHERE id_noticias = '$id'";
...
<html lang="es">
	...
	<body>
		<div class="container">
			...
			<a href="tablanoticias.php" class="btn btn-primary" id="btncontactodelete">Regresar</a>
		</div>
